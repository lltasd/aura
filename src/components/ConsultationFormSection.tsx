    ...
    <section className="mt-20 mb-20 relative px-4">
      ...
      <div className="relative bg-white/40 backdrop-blur-xl rounded-3xl border-2 border-white/60 shadow-2xl overflow-hidden max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2">
          ...
          <div className="p-8 sm:p-12 lg:p-16 flex flex-col justify-center bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white relative overflow-hidden">
            {/* Декоративные круги */}
            ...
            <div className="relative z-10">
              ...
              <h3 className="text-3xl md:text-4xl lg:text-5xl font-black leading-tight mb-6">
          ...
          {/* Правая часть - Форма */}
          <div className="p-8 sm:p-12 lg:p-16 bg-white/60 backdrop-blur-sm">
            <div className="space-y-5">
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <User className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors ${
                    focused === 'name' ? 'text-blue-600' : 'text-slate-400'
                  }`} />
                  <input
                    value={formData.name}
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <Phone className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors ${
                    focused === 'phone' ? 'text-blue-600' : 'text-slate-400'
                  }`} />
                  <input
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <Mail className={`absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 transition-colors ${
                    focused === 'email' ? 'text-blue-600' : 'text-slate-400'
                  }`} />
                  <input
              ...
              <button
                ...
                className="w-full mt-6 px-8 py-4 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold text-lg shadow-xl hover:shadow-2xl hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-3 group"
              >
