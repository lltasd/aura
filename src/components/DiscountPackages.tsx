  ...
  return (
    <section className="py-16 bg-gradient-to-b from-accent/10 via-white to-accent/5">
      <div className="container mx-auto px-4">
        ...
        >
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-accent/20 to-accent/10 px-4 py-2 rounded-full mb-4">
          ...
          {packages.map((pkg: DiscountPackage, index: number) => {
            ...
            return (
              ...
              >
                {/* Best offer badge */}
                {isBest && (
                  <div className="bg-gradient-to-r from-accent to-silver-light text-primary px-4 py-2 text-center font-bold text-sm">
                    ⭐ ЛУЧШЕЕ ПРЕДЛОЖЕНИЕ
                  </div>
                )}
                ...
                <div className={`${
                  isBest 
                    ? 'bg-gradient-to-br from-accent via-silver-light to-accent text-primary' 
                  ...
                  <ul className="space-y-2.5">
                    {pkg.services.map((service, idx) => (
                      <li key={idx} className="flex items-start gap-2.5 text-gray-700 group/item">
                        <Check className="text-accent flex-shrink-0 mt-0.5 group-hover:scale-110 transition-transform duration-150" size={16} />
                ...
                <div className="p-6 bg-gradient-to-b from-accent/10 to-accent/20 border-t border-gray-100 mt-auto">
                  ...
                  <div className="text-center">
                    <span className="inline-flex items-center gap-1.5 bg-accent text-primary px-3 py-1.5 rounded-full text-xs font-bold">
