      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          >
            <button
              onClick={onBookClick}
              className="group bg-gradient-to-r from-silver-dark to-silver hover:from-silver hover:to-silver-light text-primary px-10 py-5 rounded-2xl font-bold text-lg transition-all transform hover:scale-105 shadow-2xl shadow-silver/30 inline-flex items-center gap-3"
            >
