      ...
      <main className="container mx-auto px-4 pt-44 pb-16">
        <section className="grid lg:grid-cols-3 gap-8 items-start">
          ...
          <aside className="space-y-6 lg:sticky lg:top-40">
            ...
            <div className="group relative">
              <div className="absolute -inset-1 bg-gradient-to-br from-blue-600 via-blue-400 to-slate-400 rounded-3xl opacity-30 group-hover:opacity-50 blur-xl transition-all duration-700" />
              <div className="relative p-7 rounded-3xl bg-gradient-to-br from-blue-600/95 via-blue-700/95 to-slate-700/95 backdrop-blur-xl border border-blue-400/30 shadow-2xl">
